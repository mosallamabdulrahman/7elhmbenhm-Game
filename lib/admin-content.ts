...
const fetchAllRows = async (
  buildQuery: () => any
): Promise<{ rows: any[] | null; error: any | null }> => {
  const rows: any[] = [];
...
export const loadAllCategories = (supabaseAdmin: SupabaseClient) =>
  fetchAllRows(() =>
    supabaseAdmin
...
export const loadAllQuestions = (supabaseAdmin: SupabaseClient) =>
  fetchAllRows(() =>
    supabaseAdmin
      .from("question_bank")
      .select("*")
...
export const loadAllCategoryGroups = (supabaseAdmin: SupabaseClient) =>
  fetchAllRows(() =>
    supabaseAdmin
