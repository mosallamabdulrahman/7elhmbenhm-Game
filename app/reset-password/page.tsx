...
type StatusType = "checking" | "ready" | "invalid" | "success";
...
export default function ResetPasswordPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FCFDFF] flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8 dir-rtl">
        ...
        >
          ...
          {status === "invalid" && (
            <div className="flex flex-col items-center gap-3 py-4 text-center">
              ...
              <Link
                href="/login"
                className="mt-3 w-full flex items-center justify-center gap-2 py-3 px-4 rounded-xl text-sm font-bold text-white bg-gradient-to-r from-[var(--color-primary-blue)] to-[var(--color-depth-blue)] hover:shadow-cyan-600/25 transition-all"
              >
                ارجع لصفحة الدخول
              </Link>
            </div>
