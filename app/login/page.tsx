...
type SuccessModeType = "register" | "reset";
...
export default function QuickLoginPage() {
  ...
  const [successMode, setSuccessMode] = useState<SuccessModeType>("register");
  const [msg, setMsg] = useState<string>("");
  const [isError, setIsError] = useState<boolean>(false);
  // When a login attempt finds no account, offer a one-click hop to Register
  const [notFoundHint, setNotFoundHint] = useState<boolean>(false);
  ...
  useEffect(() => {
    ...
    if (typeof window !== "undefined" && localStorage.getItem(WAS_HERE_KEY)) {
      setTab("login");
    }
  ...
  return (
    <div className="min-h-screen bg-[#FCFDFF] flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden dir-rtl">
      <div className="absolute top-10 right-10 w-72 h-72 bg-emerald-200/40 rounded-full blur-3xl pointer-events-none animate-pulse" />
      <div className="absolute bottom-10 left-10 w-80 h-80 bg-cyan-100/40 rounded-full blur-3xl pointer-events-none" />
            ...
            {sent ? (
              ...
              >
                ...
                <div>
                  ...
                  <p
                    className="text-sm font-bold text-[var(--color-primary-blue)] mt-1 break-all"
                    dir="ltr"
                  >
                    {sentEmail}
                  </p>
                        ...
                        >
                          ...
                          {notFoundHint && (
                            <button
                              ...
                              className="inline-flex items-center gap-1.5 text-xs font-bold text-[var(--color-primary-blue)] underline underline-offset-2 cursor-pointer"
                            >
                          ...
                          {resolvedLoginEmail && (
                            <button
                              ...
                              disabled={isLoading}
                              className="inline-flex items-center gap-1.5 text-xs font-bold text-[var(--color-primary-blue)] underline underline-offset-2 cursor-pointer disabled:opacity-60"
                            >
