...
export default function SiteGatePage() {
  ...
  return (
    <div className="min-h-screen bg-[#FCFDFF] flex items-center justify-center p-4 dir-rtl">
      <motion.div
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-3 text-right">
          ...
          <button
            ...
            className="w-full bg-gradient-to-r from-[var(--color-primary-blue)] to-[var(--color-depth-blue)] hover:shadow-md py-3 rounded-xl font-bold text-white text-sm transition-all flex items-center justify-center gap-2 disabled:opacity-60 cursor-pointer"
          >
            {isLoading ? (
