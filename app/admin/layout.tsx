...
function AdminTopBar({ displayName, onSignOut }: AdminTopBarProps) {
      ...
      >
        ...
        >
          ...
          <div>
            ...
            <div className="relative mt-1">
              ...
              <button
                ...
                className="absolute left-2 top-1/2 -translate-y-1/2 text-slate-500 cursor-pointer"
              >
                {showPassword ? (
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full flex items-center justify-center gap-2 rounded-xl bg-cyan-600 py-3 text-sm font-bold text-white hover:bg-cyan-500 transition disabled:opacity-60 cursor-pointer"
          >
            {isLoading ? (
