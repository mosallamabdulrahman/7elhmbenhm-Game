        ...
        <div className="max-w-2xl">
          ...
          <div className="flex gap-4">
            <button
              ...
              className="bg-[#2271b1] hover:bg-[#135e96] text-white text-sm font-semibold px-4 py-2 rounded shadow transition cursor-pointer"
            >
              إدارة الأسئلة الحالية
            </button>
            <button
              onClick={() => setTab("categories")}
              className="bg-white hover:bg-slate-50 border border-slate-300 text-slate-700 text-sm font-semibold px-4 py-2 rounded transition cursor-pointer"
            >
