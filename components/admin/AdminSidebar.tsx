            ...
            return (
              ...
              >
                ...
                {key === "support" && unreadSupportCount > 0 && (
                  <span className="inline-flex items-center justify-center px-2 py-0.5 text-[10px] font-bold rounded-full bg-amber-500 text-slate-950 shadow-sm animate-pulse">
                    {unreadSupportCount}
                  </span>
                )}
              </button>
