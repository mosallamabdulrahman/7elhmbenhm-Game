...
export default function PaymentGateSection() {
  ...
  return (
    <section
      id="payment-gate"
      className="py-8 sm:py-12 bg-transparent relative overflow-hidden"
    >
          ...
          {packages.map((pkg, idx) => (
            ...
            >
              ...
              <div className="bg-slate-50/80 rounded-2xl p-5 border border-slate-100 mb-6 text-center">
                ...
                <span className="text-3xl text-slate-800 flex items-center justify-center gap-1.5 mt-1 font-bold">
                  {pkg.points}
